...
let songs = [
    ...
    {songName: 'Salam-e-ishq1', filePath: 'songs/2.mp3', coverPath: "covers/2.jpg"},
...
songItem.forEach((element, index)=>{
    let audioLength = new Audio(songs[index].filePath);
    element.getElementsByTagName("img")[0].src = songs[index].coverPath;
    element.getElementsByClassName("song-name")[0].innerText = songs[index].songName;
   // element.getElementsByClassName("timestamp")[0].innerText = audioLength.duration;
})
